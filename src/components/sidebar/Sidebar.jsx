          ...
          <ul className='flex flex-col gap-1.5'>
            <li className='flex'>
              <NavLink
                ...
                className={`all-sidebar-item home-page-list-item px-3 w-full py-[6px] rounded-[3px] font-medium transition-colors cursor-pointer select-none text-[15px] text-black dark:text-white whitespace-nowrap`}
                to='/'>
                Anasayfa
              </NavLink>
            </li>
