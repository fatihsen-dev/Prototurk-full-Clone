  ...
  return (
    <div className='overflow-auto dark:bg-dark h-full w-full flex-1 flex flex-col items-start pb-10 px-5 2xl:px-40 xl:px-24 lg:px-14 md:px-5 sm:px-5'>
      <div className='flex-1 flex flex-col items-start container mx-auto py-8'>
        ...
        <div className='flex flex-col gap-4 items-start dark:bg-darkBlueTwo dark:text-white bg-gray-100 p-5 mt-5 relative'>
          <p className="z-30">
          ...
          <span className='flex w-10 h-10 bg-gray-100 left-0 top-1 absolute -skew-x-[45deg] rotate-[90deg] -z-10 dark:bg-darkBlueTwo dark:z-10'></span>
        </div>
      </div>
    </div>
  );
